                        ...
                        @foreach($templates as $template)
                            <div
                                ...
                                <div class="relative z-10 flex-1">
                                    ...
                                    <p class="text-sm font-medium text-koperasi-dark/60 mb-6">
                                ...
                                <div
                                    ...
                                    @if($points >= $template->points_cost)
                                        <button wire:click="redeem('{{ $template->_id }}')"
                                            wire:confirm="Tukar {{ $template->points_cost }} poin dengan voucher ini?"
