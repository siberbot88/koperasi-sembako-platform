                ...
                <form wire:submit="save" class="space-y-4">
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-2 gap-2 mt-1">
                            <label class="px-3 py-2 border-2 rounded-lg cursor-pointer flex items-center justify-center text-xs font-bold transition-colors {{ $pointsCost == 0 ? 'bg-koperasi-primary/20 border-koperasi-primary text-koperasi-black' : 'border-gray-200 text-gray-500' }}">
                                <input type="radio" wire:model.live="pointsCost" value="0" class="sr-only">
                                Kupon Publik
                            </label>
                            <label class="px-3 py-2 border-2 rounded-lg cursor-pointer flex items-center justify-center text-xs font-bold transition-colors {{ $pointsCost > 0 ? 'bg-koperasi-accent/30 border-koperasi-primary text-koperasi-black' : 'border-gray-200 text-gray-500' }}">
                                <input type="radio" wire:model.live="pointsCost" value="10" class="sr-only">
                                Reward Poin
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="bg-koperasi-accent/10 p-3 rounded-xl border border-koperasi-accent/30">
                        ...
                        <input type="number" wire:model="pointsCost" class="input" min="1">
                    ...
                    <table class="table-koperasi w-full">
                        ...
                        <tbody>
                            ...
                            <tr class="hover:bg-koperasi-dark/5">
                                ...
                                <td class="text-right">
                                    <button wire:click="delete('{{ $coupon->_id }}')" wire:confirm="Hapus banner ini?" class="text-red-500 hover:text-red-700 p-2">
